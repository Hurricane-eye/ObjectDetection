...
def get_model():
    ...
    model = torchvision.models.detection.fasterrcnn_resnet50_fpn(pretrained=True, min_size=540, max_size=960)
    ...
    # model = FasterRCNN(backbone, num_classes=num_classes, min_size=540, max_size=2000,
